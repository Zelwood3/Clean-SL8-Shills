...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.EthashDatasetDir = filepath.Join(home, "AppData", "SL8_Ethash")
	} else {
		DefaultConfig.EthashDatasetDir = filepath.Join(home, ".sl8_ethash")
	}
}
